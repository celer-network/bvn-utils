module github.com/celer-network/bvn-utils
...
require (
	github.com/brevis-network/brevis-sdk v0.3.32
	github.com/brevis-network/zk-utils v0.0.0-20250220022014-f120b7a5df0a
